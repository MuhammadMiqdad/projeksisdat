...
<body style="background-image: url('image/bg.jpg');">
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-lg-4">
        <div class="card mb-3">
          <img src="image/aqua.jpg" class="card-img-top" alt="Item Image">
          <div class="card-body">
            <h5 class="card-title">AQUA</h5>
            <p class="card-text">Aqua 600 ml air mineral
              <br>
              <small>Rp. 4000</small>
            </p>
          </div>
          <div class="card-footer">
            <button class="btn btn-primary" onclick="addToCart('Aqua', 4000)">Add to Cart</button>
          </div>
        </div>
      </div>
      <div class="col-lg-4">
